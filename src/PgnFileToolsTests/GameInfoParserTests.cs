...
namespace PgnFileToolsTests
{
    ...
    public class GameInfoParserTests
    {
        ...
        public void Given_a_move_variation_after_a_move_text__should_add_the_variation_to_the_Move_information()
        {
            ...
            result.Moves[0].ToAlgebraicString().ShouldBeEqualTo("f4");
            result.Moves[0].Number.ShouldBeEqualTo(6);
            result.Moves[1].ToAlgebraicString().ShouldBeEqualTo("e6");
            result.Moves[1].Variation.ShouldBeEqualTo("6... b5");
        }
        ...
        public void Given_a_recursive_move_variation_after_a_move_text__should_add_the_variation_to_the_Move_information()
        {
            ...
            result.Moves[0].Number.ShouldBeEqualTo(6);
            result.Moves[1].ToAlgebraicString().ShouldBeEqualTo("e6");
            result.Moves[1].Variation.ShouldBeEqualTo("6... b5 (6... b4)");
        }
